class LogoComponent < Phlex::SVG
  def initialize(width: 40, height: 40, color: "white")
    @width = width
    @height = height
    @color = color
  end
  ...
  def view_template
    svg width: @width, height: @height, viewBox: "0 0 280 300", fill: @color, xmlns: svg_namespace do
